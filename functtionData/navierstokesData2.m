function pde = navierstokesData2(coeff_case, u_case)
%
%   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
%   %--------------------------------------------
...
switch u_case
    case 1
        ...
        f1 = @(x,y) -mu(x,y).*(2*u1xx(x,y)+u1yy(x,y)+u2xy(x,y))+(u1(x,y).*u1x(x,y)+u2(x,y).*u1y(x,y))+px(x,y);
        f2 = @(x,y) -mu(x,y).*(u1xy(x,y)+u2xx(x,y)+2*u2yy(x,y))+(u1(x,y).*u2x(x,y)+u2(x,y).*u2y(x,y))+py(x,y);
