function [sysErr,sysTime] = dgTimeDecoupledSDTEqn1(pde,option,varargin)
%
%   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
%   %--------------------------------------------
%       dgTimeDecoupledSDT1, 
...
if ~exist('pde','var')
    pde = TimeDecoupledSDTData1(0,1); % default data
end
...
% Ndof = zeros(maxIt,1);
dgTimeDecoupledSDT1_output = cell(maxIt,1);

%% set path and file name
load('setpath_pwd.mat')
dgfunc_name = 'dgTimeDecoupledSDT1_';
...
%     Dnode = vertices'; Delem = elements';
    ...
    %% solve equations
    solve_t0 = cputime;
    [SD_Uh, Ch, sysInfo]= dgTimeDecoupledSDTSolve1(StokesmeshInfo,DarcymeshInfo,pde,option);
    ...
    dgTimeDecoupledSDT1_output{n,1} = ...
        struct( ...
...
save(saveFilename, 'dgTimeDecoupledSDT1_output');
