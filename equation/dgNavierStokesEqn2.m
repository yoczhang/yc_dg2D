function [sysErr,sysTime] = dgNavierStokesEqn2(pde,option,varargin)
%
%   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
%   %--------------------------------------------
...
if ~exist('pde','var')
    pde = navierstokesData2(0,1); % default data
end
...
%     end
    ...
    %% solve equations
    solve_t0 = cputime;
    [Uh, sysInfo]= dgNavierStokesSolve2(meshInfo,pde,option);
