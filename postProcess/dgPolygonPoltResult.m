function [DGM, DGT, DGuh, DGuhx, DGuhy] = dgPolygonPoltResult(Uh, meshInfo, degreek)
%
...
%-------------------------------------------------------------------------------------------------------------------%
    ...
    for nt = 1:(size(coordTri0Elem,1)/3)
        ...
        value_uhx_onTri = trialPbx*Uh((ii-1)*Nbases+1:ii*Nbases);
        value_uhy_onTri = trialPby*Uh((ii-1)*Nbases+1:ii*Nbases);
