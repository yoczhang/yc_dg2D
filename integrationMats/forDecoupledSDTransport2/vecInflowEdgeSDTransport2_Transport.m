function C_K_inflow = ...
    vecInflowEdgeSDTransport2_Transport(t, pde, ...
...
if isempty(lastStep_DarcyUh) || isempty(lastStep_StokesUh)
    error('in vecInflowEdgeSDTransport_Transport.m, lastStep_Uh is []')
end
...
%---- check mesh information: inflow edges 
