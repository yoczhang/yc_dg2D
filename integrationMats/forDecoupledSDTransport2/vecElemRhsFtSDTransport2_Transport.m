function vecRhsFt = vecElemRhsFtSDTransport2_Transport(t, ...
...
if isempty(lastStep_DarcyUh)
    error('in vecElemRhsFtSDTransport2_Transport.m, lastStep_DarcyUh is []')
end
if isempty(lastStep_StokesUh)
    error('in vecElemRhsFtSDTransport2_Transport.m, lastStep_StokesUh is []')
end
