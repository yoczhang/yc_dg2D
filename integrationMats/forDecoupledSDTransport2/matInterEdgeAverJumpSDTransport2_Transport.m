function [C_diff_K_noAdapE, C_diff_K_AdapE, C_conv_K] = ...
...
if isempty(lastStep_DarcyUh)
    error('in matInterEdgeAverJumpSDTransport2_Transport.m, lastStep_DarcyUh is []')
end
if isempty(lastStep_StokesUh)
    error('in matInterEdgeAverJumpSDTransport2_Transport.m, lastStep_StokesUh is []')
end
