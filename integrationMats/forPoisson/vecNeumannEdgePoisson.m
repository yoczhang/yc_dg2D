function rhsNeumann = vecNeumannEdgePoisson(Coeffs_func,pde,meshInfo,formulaGauss1D,degreek_test)
%
...
%-------------------------------------------------------------------------------------------------------------------%
    ...
    rhsNeu_temp = elemP_testPb' * (elemP_nu(1)*phyGweights.*valueCoeff_k11.*value_phix ...
        + elemP_nu(2)*phyGweights.*valueCoeff_k22.*value_phiy);
