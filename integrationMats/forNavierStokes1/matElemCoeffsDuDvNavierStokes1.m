function [G_UxxPlusG_Uyy,G_U_nolinearTerm,G_P00Vx0,G_P00V0y,G_P00,vecRhsF1,vecRhsF2,vecLambdaP] = ...
    matElemCoeffsDuDvNavierStokes1(Coeffs_func,func_f1,func_f2, lastStepUh, ...
...
G_UxxPlusG_Uyy = sparse(Nelems*NTbases_u,Nelems*NTbases_u);
G_U_nolinearTerm = sparse(Nelems*NTbases_u,Nelems*NTbases_u);

G_P00Vx0 = sparse(Nelems*NTbases_u,Nelems*NTbases_p);
G_P00V0y = sparse(Nelems*NTbases_u,Nelems*NTbases_p);
G_P00 = sparse(Nelems*NTbases_p,Nelems*NTbases_p);
...
%-------------------------------------------------------------------------------------------------------------------%
    ...
    Gxx_temp = zeros(NTbases_u, NTbases_u);
    Gyy_temp = zeros(NTbases_u, NTbases_u);
    G_U_nolinearTerm_temp = zeros(NTbases_u, NTbases_u);
    G_P00Vx0_temp = zeros(NTbases_u, NTbases_p);
    G_P00V0y_temp = zeros(NTbases_u, NTbases_p);
    G_P00_temp = zeros(NTbases_p, NTbases_p);
    ...
    for nt = 1:(size(coordTri0Elem,1)/3)
        ...
        %-- MatElem
        Gxx_temp = Gxx_temp + getMatOnElem(valueCoeff_k11, u_Pbx, u_Pbx, phyGweights);
        Gyy_temp = Gyy_temp + getMatOnElem(valueCoeff_k22, u_Pby, u_Pby, phyGweights);
        G_P00Vx0_temp = G_P00Vx0_temp + getMatOnElem(valueCoeff_one, q_Pb, u_Pbx, phyGweights);
        G_P00V0y_temp = G_P00V0y_temp + getMatOnElem(valueCoeff_one, q_Pb, u_Pby, phyGweights);
        G_P00_temp = G_P00_temp + getMatOnElem(valueCoeff_one, q_Pb, q_Pb, phyGweights);
    ...
    qqRow_elem = ((CurrElem-1)*NTbases_p+1 : CurrElem*NTbases_p)' ...
        * ones(1,NTbases_p); % [NTbases_p x NTbases_p]
    qqCol_elem = ones(NTbases_p, 1) ...
        *((CurrElem-1)*NTbases_p+1 : CurrElem*NTbases_p); % [NTbases_p x NTbases_p]
    
    G_UxxPlusG_Uyy = G_UxxPlusG_Uyy ...
    ...
    G_P00V0y = G_P00V0y ...
        ...
        Nelems*NTbases_u, Nelems*NTbases_p);
    G_P00 = G_P00 ...
        + sparse(qqRow_elem(:), qqCol_elem(:), ...
        G_P00_temp(:), ...
        Nelems*NTbases_p, Nelems*NTbases_p);
