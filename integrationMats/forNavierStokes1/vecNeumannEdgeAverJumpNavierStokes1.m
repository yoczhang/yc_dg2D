function [Krhs_gN1,Krhs_gN2] = ...
    vecNeumannEdgeAverJumpNavierStokes1(pde, meshInfo, formulaGauss1D, degreek_u)
%
%   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
%   %--------------------------------------------
...
DirichletEdges = meshInfo.NeumannEdgeIndex; % here we need the DirichletEdges information.
...
%-------------------------------------------------------------------------------------------------------------------%
    ...
    Krhs_gN1(rhsNeuRow,1) = Krhs_gN1(rhsNeuRow,1) ...
        +( K_gN1_temp );
    Krhs_gN2(rhsNeuRow,1) = Krhs_gN2(rhsNeuRow,1) ...
        +( K_gN2_temp );
