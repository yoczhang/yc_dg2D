function [K00inter_uv, K00inter_pv1, K00inter_pv2, Kinter_nolinearTerm] = ...
    matInterEdgeAverJumpNavierStokes1(Coeffs_func, lastStepUh, ...
...
NTbases_q = (degreek_p+1)*(degreek_p+2)/2;

K00inter_uv = sparse(Nelems*NTbases_u,Nelems*NTbases_u);
K00inter_pv1 = sparse(Nelems*NTbases_u,Nelems*NTbases_q);
K00inter_pv2 = sparse(Nelems*NTbases_u,Nelems*NTbases_q);
