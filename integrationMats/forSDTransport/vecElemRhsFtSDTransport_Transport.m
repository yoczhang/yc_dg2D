function vecRhsFt = vecElemRhsFtSDTransport_Transport(t, ...
...
%-------------------------------------------------------------------------------------------------------------------%
    ...
    for nt = 1:(size(coordTri0Elem,1)/3)
        ...
        valuefunc_f = pde.ct(t,phyGpoints(:,1),phyGpoints(:,2)) ...
            ...
            - elem_DC*(pde.cx(t,phyGpoints(:,1),phyGpoints(:,2))+pde.cxx(t,phyGpoints(:,1),phyGpoints(:,2))) ...
            - elem_DC*(pde.cy(t,phyGpoints(:,1),phyGpoints(:,2))+pde.cyy(t,phyGpoints(:,1),phyGpoints(:,2)));
