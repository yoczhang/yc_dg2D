function matInterEdge = ...
    matInterEdgeAverJumpSDTransport_Poisson(Coeffs_func, meshInfo, option,formulaGauss1D,degreek_trial,degreek_test)
%
%   %---------------------------------------------------------------------
...
%
    ...
    A1_pp = 0.5*( elemP_nu(1) * elemP_testPb' * bsxfun(@times,elemP_value_DC.*valueCoeff_1.*phyGaussweights,elemP_trialPbx) ...
        + elemP_nu(2) * elemP_testPb' * bsxfun(@times,elemP_value_DC.*valueCoeff_2.*phyGaussweights,elemP_trialPby) );
        %> [NTbases_test x Npoints] * [Npoints x NTbases_trial] = [NTbases_test x NTbases_trial].
    
    A1_pm = 0.5*( elemP_nu(1) * elemP_testPb' * bsxfun(@times,elemM_value_DC.*valueCoeff_1.*phyGaussweights,elemM_trialPbx) ...
        + elemP_nu(2) * elemP_testPb' * bsxfun(@times,elemM_value_DC.*valueCoeff_2.*phyGaussweights,elemM_trialPby) );
        %> [NTbases_test x Npoints] * [Npoints x NTbases_trial] = [NTbases_test x NTbases_trial].
        
    A1_mp = 0.5*( elemM_nu(1) * elemM_testPb' * bsxfun(@times,elemP_value_DC.*valueCoeff_1.*phyGaussweights,elemP_trialPbx) ...
        + elemM_nu(2) * elemM_testPb' * bsxfun(@times,elemP_value_DC.*valueCoeff_2.*phyGaussweights,elemP_trialPby) );
        %> [NTbases_test x Npoints] * [Npoints x NTbases_trial] = [NTbases_test x NTbases_trial].
        
    A1_mm = 0.5*( elemM_nu(1) * elemM_testPb' * bsxfun(@times,elemM_value_DC.*valueCoeff_1.*phyGaussweights,elemM_trialPbx) ...
        + elemM_nu(2) * elemM_testPb' * bsxfun(@times,elemM_value_DC.*valueCoeff_2.*phyGaussweights,elemM_trialPby) );
        %> [NTbases_test x Npoints] * [Npoints x NTbases_trial] = [NTbases_test x NTbases_trial].
    ...
    A2_pp = 0.5*( elemP_nu(1) * (elemP_value_DC.*elemP_testPbx)' * bsxfun(@times,valueCoeff_1.*phyGaussweights,elemP_trialPb) ...
        + elemP_nu(2) * (elemP_value_DC.*elemP_testPby)' * bsxfun(@times,valueCoeff_2.*phyGaussweights,elemP_trialPb) );
        %> [NTbases_test x Npoints] * [Npoints x NTbases_trial] = [NTbases_test x NTbases_trial].
    
    A2_pm = 0.5*( elemM_nu(1) * (elemP_value_DC.*elemP_testPbx)' * bsxfun(@times,valueCoeff_1.*phyGaussweights,elemM_trialPb) ...
        + elemM_nu(2) * (elemP_value_DC.*elemP_testPby)' * bsxfun(@times,valueCoeff_2.*phyGaussweights,elemM_trialPb) );
        %> [NTbases_test x Npoints] * [Npoints x NTbases_trial] = [NTbases_test x NTbases_trial].
        
    A2_mp = 0.5*( elemP_nu(1) * (elemM_value_DC.*elemM_testPbx)' * bsxfun(@times,valueCoeff_1.*phyGaussweights,elemP_trialPb) ...
        + elemP_nu(2) * (elemM_value_DC.*elemM_testPby)' * bsxfun(@times,valueCoeff_2.*phyGaussweights,elemP_trialPb) );
        %> [NTbases_test x Npoints] * [Npoints x NTbases_trial] = [NTbases_test x NTbases_trial].
        
    A2_mm = 0.5*( elemM_nu(1) * (elemM_value_DC.*elemM_testPbx)' * bsxfun(@times,valueCoeff_1.*phyGaussweights,elemM_trialPb) ...
        + elemM_nu(2) * (elemM_value_DC.*elemM_testPby)' * bsxfun(@times,valueCoeff_2.*phyGaussweights,elemM_trialPb) );
        %> [NTbases_test x Npoints] * [Npoints x NTbases_trial] = [NTbases_test x NTbases_trial].
