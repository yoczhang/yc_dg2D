function [matInterEdge_uv, matInterEdge_qv1, matInterEdge_qv2] = ...
    matInterEdgeAverJumpScalarStokes_SD(Coeffs_func, meshInfo, option, formulaGauss1D, degreek_u, degreek_q)
%
