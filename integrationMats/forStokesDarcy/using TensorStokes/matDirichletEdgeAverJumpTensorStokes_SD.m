function [matDirichletEdge_u1v1,matDirichletEdge_u1v2,matDirichletEdge_u2v1,matDirichletEdge_u2v2,matDirichletEdge_pv1,matDirichletEdge_pv2,rhs_gD1,rhs_gD2,rhs_div] = ...
    matDirichletEdgeAverJumpTensorStokes_SD(Coeffs_func, func_gD1, func_gD2, meshInfo, option, formulaGauss1D, degreek_u, degreek_p)
%
...
matDirichletEdge_pv1 = sparse(Nelems*NTbases_u,Nelems*NTbases_p);
matDirichletEdge_pv2 = sparse(Nelems*NTbases_u,Nelems*NTbases_p);
