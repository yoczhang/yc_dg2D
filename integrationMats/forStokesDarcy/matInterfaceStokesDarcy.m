function [interface_uphi_n1, interface_uphi_n2, interface_phiu_n1, interface_phiu_n2] = ...
    matInterfaceStokesDarcy(Coeffs_func, StokesmeshInfo, DarcymeshInfo, interfacemeshInfo, formulaGauss1D, degreek_u, degreek_phi)
%
...
%       interface_phiu, u is the Stokes bases, is the test function, [Nelems_S*NTbases_u x Nelems_D*NTbases_phi].
%
%
%   YcZhang 30/8/2017
%
