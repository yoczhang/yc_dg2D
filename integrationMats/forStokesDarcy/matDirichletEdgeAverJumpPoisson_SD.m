function [matDirichletEdge, rhs_gD] = ...
    matDirichletEdgeAverJumpPoisson_SD(Coeffs_func,func_gD,meshInfo, option,formulaGauss1D,degreek_trial,degreek_test)
%
...
matDirichletEdge = sparse(Nelems*Nbases_test,Nelems*Nbases_trial);
rhs_gD = zeros(Nelems*Nbases_test,1);
...
%-------------------------------------------------------------------------------------------------------------------%
    ...
    [Row, Col] = getROWandCOL(elemP, 0, Nbases_trial, Nbases_test);
