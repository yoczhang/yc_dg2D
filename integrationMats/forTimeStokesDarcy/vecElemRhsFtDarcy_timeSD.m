function vecRhs_f1 = vecElemRhsFtDarcy_timeSD(t, func_f1, meshInfo, formulaGauss2D, degreek_test)
%
...
vecRhs_f1 = zeros(Nelems*Nbases_test,1);
...
%-------------------------------------------------------------------------------------------------------------------%
    ...
    rhs_f1_temp = zeros(Nbases_test,1);
