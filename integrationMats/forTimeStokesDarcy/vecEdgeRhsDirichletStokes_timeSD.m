function [rhs_gD1, rhs_gD2, rhs_div] = ...
    vecEdgeRhsDirichletStokes_timeSD(t, Coeffs_func, func_gD1, func_gD2, ...
...
%-------------------------------------------------------------------------------------------------------------------%
    ...
    r2 = 0.5 * elemP_nu(2) * u_elemP_Pbx' *  (valueCoeff_k22.*valuefunc_gD1.*phyGweights) ...
        + 0.5 * elemP_nu(1) * u_elemP_Pbx' *  (valueCoeff_k22.*valuefunc_gD2.*phyGweights) ...
