function [rhsFricEdge_gN1, rhsFricEdge_gN2] = ...
...
rhsFricEdge_gN1 = zeros(Nelems*NTbases_u,1);
rhsFricEdge_gN2 = zeros(Nelems*NTbases_u,1);
...
for CurrEdge = 1:length(FrictionEdges_1)
    ...
    valuefunc_gN1 = pde.u1x(phyGpointsX, phyGpointsY)*elemP_nu(1) ...
        + pde.u1y(phyGpointsX, phyGpointsY)*elemP_nu(2); % [Npoints x 1]
    valuefunc_gN2 = pde.u2x(phyGpointsX, phyGpointsY)*elemP_nu(1) ...
        + pde.u2y(phyGpointsX, phyGpointsY)*elemP_nu(2); % [Npoints x 1]
...
%-------------------------------------------------------------------------------------------------------------------%
    ...
    r_temp_gN1 = u_elemP_Pb' *  (lastStepLambda.*valuefunc_gN1.*phyGweights);
        %> [NTbases_test x Npoints] * [Npoints x 1] = [NTbases_test x 1].
    r_temp_gN2 = u_elemP_Pb' *  (lastStepLambda.*valuefunc_gN2.*phyGweights);
        %> [NTbases_test x Npoints] * [Npoints x 1] = [NTbases_test x 1].
    rhsFricEdge_gN1(rhsRow,1) = rhsFricEdge_gN1(rhsRow,1) + r_temp_gN1;
    rhsFricEdge_gN2(rhsRow,1) = rhsFricEdge_gN2(rhsRow,1) + r_temp_gN2;
    %<<-- End Part II --------------------------------------------------------------------------------------
