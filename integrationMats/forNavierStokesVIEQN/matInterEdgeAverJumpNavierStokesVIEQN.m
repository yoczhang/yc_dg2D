function [InterK_u1v1, InterK_u1v2, InterK_u2v1, InterK_u2v2, InterK_pv1, InterK_pv2, InterK_nolinearTerm] = ...
    matInterEdgeAverJumpNavierStokesVIEQN(Coeffs_func, lastStepUh,...
    meshInfo, option, formulaGauss1D, degreek_u, degreek_p)
%
%   %-----------------------------------------------------------
%       Just copy form matInterEdgeAverJumpNavierStokes2.m
%   %------------------------------------------------------------
%
%   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
%   %--------------------------------------------
...
InterK_u1v1 = sparse(Nelems*NTbases_u,Nelems*NTbases_u);
InterK_u1v2 = sparse(Nelems*NTbases_u,Nelems*NTbases_u);
InterK_u2v1 = sparse(Nelems*NTbases_u,Nelems*NTbases_u);
InterK_u2v2 = sparse(Nelems*NTbases_u,Nelems*NTbases_u);
InterK_nolinearTerm = sparse(Nelems*NTbases_u,Nelems*NTbases_u);
InterK_pv1 = sparse(Nelems*NTbases_u,Nelems*NTbases_p);
InterK_pv2 = sparse(Nelems*NTbases_u,Nelems*NTbases_p);
...
%-------------------------------------------------------------------------------------------------------------------%
    ...
    InterK_nolinearTerm = InterK_nolinearTerm ...
        + sparse(uv_Row(:), uv_Col(:), ...
...
K2_mm = u_elemM_Pb' * bsxfun(@times, jumpLastStep_uh.*phyGaussweights, u_elemM_Pb);
