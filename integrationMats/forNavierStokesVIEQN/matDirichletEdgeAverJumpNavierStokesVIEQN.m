function [DirichletK_u1v1,DirichletK_u1v2,DirichletK_u2v1,DirichletK_u2v2,DirichletK_pv1,DirichletK_pv2,DiriK_nolinearTerm,rhs_gD1,rhs_gD2,rhs_div] = ...
    matDirichletEdgeAverJumpNavierStokesVIEQN(Coeffs_func, func_gD1, func_gD2, lastStepUh, ...
    meshInfo, option, formulaGauss1D, degreek_u, degreek_p)
%
%   %----------------------------------------------------------
%       Just copy form matDirichletEdgeAverJumpNavierStokes2.m
%   %----------------------------------------------------------
%
...
DirichletK_u1v1 = sparse(Nelems*NTbases_u,Nelems*NTbases_u);
DirichletK_u1v2 = sparse(Nelems*NTbases_u,Nelems*NTbases_u);
DirichletK_u2v1 = sparse(Nelems*NTbases_u,Nelems*NTbases_u);
DirichletK_u2v2 = sparse(Nelems*NTbases_u,Nelems*NTbases_u);
DiriK_nolinearTerm = sparse(Nelems*NTbases_u,Nelems*NTbases_u);
DirichletK_pv1 = sparse(Nelems*NTbases_u,Nelems*NTbases_p);
DirichletK_pv2 = sparse(Nelems*NTbases_u,Nelems*NTbases_p);
...
%-------------------------------------------------------------------------------------------------------------------%
    ...
    DirichletK_u1v1 = DirichletK_u1v1 ...
    ...
    DirichletK_u1v2 = DirichletK_u1v2 ...
        + sparse(uv_Row(:), uv_Col(:), ...
        - 2*uv_A1.A1_u1v2(:) + p_epsilon*2*uv_A2.A2_u1v2(:), ...
        Nelems*NTbases_u, Nelems*NTbases_u);
    
    DirichletK_u2v1 = DirichletK_u2v1 ...
        + sparse(uv_Row(:), uv_Col(:), ...
        - 2*uv_A1.A1_u2v1(:) + p_epsilon*2*uv_A2.A2_u2v1(:), ...
        Nelems*NTbases_u, Nelems*NTbases_u);
    
    DirichletK_u2v2 = DirichletK_u2v2 ...
        + sparse(uv_Row(:), uv_Col(:), ...
    ...
    DiriK_nolinearTerm = DiriK_nolinearTerm ...
        + sparse(uv_Row(:), uv_Col(:), ...
