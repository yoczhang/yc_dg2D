...
Stokes_stiff = [mu*(elem_u1v1+Inter_u1v1+Diri_u1v1),      zeroUU,     -elem_pv1+Inter_pv1+Diri_pv1;
    zeroUU,     mu*(elem_u1v1+Inter_u1v1+Diri_u1v1),      -elem_pv2+Inter_pv2+Diri_pv2;
    -(-elem_pv1+Inter_pv1+Diri_pv1)',     -(-elem_pv2+Inter_pv2+Diri_pv2)', 1e-6*elem_p0q0];
...
for n = 0:NT-1
    ...
    vecRhs_f = [S_rhs_f1;S_rhs_f2;zeros(dof_p,1)];
    ...
    if strcmpi(bd_case,'allDirichlet')
        ...
        rhs_DiriBC = [mu*S_rhs_gD1;mu*S_rhs_gD2;-S_rhs_div];
