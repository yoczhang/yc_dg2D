function [matInterEdge, matDiffusiveAdapEdge, matConvectionUpwindEdge] = ...
    matInterEdgeAverJumpAdapTransport_fortestSDTransport1(Coeffs_func, meshInfo, option,formulaGauss1D,degreek_trial,degreek_test)
%
twoDomain2oneDomain_interEdge = ...
    [1, 4;
    2, 10;
    3, 12;
    4, 13;
...
twoDomain2oneDomain_interEdge2Elem = ...
    [1, 4, 1, 2;
    2, 10, 1, 3;
    3, 12, 2, 4;
    4, 13, 3, 4;
...
for ii = 1:length(interEdges)
    ...
    interEindx = twoDomain2oneDomain_interEdge(ii,2);
...
%-------------------------------------------------------------------------------------------------------------------%
    ...
    elemP_twoDomain = twoDomain2oneDomain_interEdge2Elem(ii,3);
    elemM_twoDomain = twoDomain2oneDomain_interEdge2Elem(ii,4);
    [Row, Col] = getROWandCOL(elemP_twoDomain, elemM_twoDomain, NTbases_trial, NTbases_test);
