function [matElem_uv, matElem_DuDv, matElem_uvx, vecRhsF] = ...
    matElemCoeffsDtrialDtestAdapTransport(Coeffs_func, func_f, meshInfo, formulaGauss2D, degreek_trial, degreek_test)
%
%   %------------------------------------------------------
%       Just copy from matElemCoeffsDtrialDtestTransport.m
%   %------------------------------------------------------
%
