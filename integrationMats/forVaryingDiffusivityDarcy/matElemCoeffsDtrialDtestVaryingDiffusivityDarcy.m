function [matElemDuDv, vecRhsF] = ...
    matElemCoeffsDtrialDtestVaryingDiffusivityDarcy(Coeffs_func, func_f, meshInfo, formulaGauss2D, degreek_trial, degreek_test)
%
%   %----------------------------------------
%       modified from: matElemCoeffsDtrialDtestPoisson.m
%   %----------------------------------------
%
