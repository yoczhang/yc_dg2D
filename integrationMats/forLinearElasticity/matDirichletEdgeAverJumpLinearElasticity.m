function [matDirichletEdge_u1v1,matDirichletEdge_u1v2,matDirichletEdge_u2v1,matDirichletEdge_u2v2,rhs_gD1,rhs_gD2] = ...
    matDirichletEdgeAverJumpLinearElasticity(Coeffs_func, pde, func_gD1, func_gD2, meshInfo, option, formulaGauss1D, degreek_u)
%
...
%         + 0.5 * eleP_nu(1) * u_eleP_Pby' *  (valueCoeff_k11.*valuefunc_gD2.*phyGweights);
    r1 = (lambda+2*mu) * eleP_nu(1) * u_eleP_Pbx' * (valueCoeff_k11.*valuefunc_gD1.*phyGweights) ...
        + mu * eleP_nu(2) * u_eleP_Pby' * (valueCoeff_k11.*valuefunc_gD1.*phyGweights) ...
        + lambda * eleP_nu(2) * u_eleP_Pbx' * (valueCoeff_k11.*valuefunc_gD2.*phyGweights) ...
        + mu * eleP_nu(1) * u_eleP_Pby' * (valueCoeff_k11.*valuefunc_gD2.*phyGweights);
        %> [NTbases_test x Npoints] * [Npoints x 1] = [NTbases_test x 1].
    r1 = p_epsilon*r1 + (p_sigma/areaEdge^p_beta)...
        * ( 3/2*u_eleP_Pb' * (phyGweights.*valuefunc_gD1) ...
        + 1/2*eleP_nu(2)*u_eleP_Pb'* (eleP_nu(1)*phyGweights.*valuefunc_gD2) );
...
%         + eleP_nu(2) * u_eleP_Pby' *  (valueCoeff_k11.*valuefunc_gD2.*phyGweights);
    r2 = mu * eleP_nu(2) * u_eleP_Pbx' * (valueCoeff_k11.*valuefunc_gD1.*phyGweights) ...
        + lambda * eleP_nu(1) * u_eleP_Pby' * (valueCoeff_k11.*valuefunc_gD1.*phyGweights) ...
        + mu * eleP_nu(1) * u_eleP_Pbx' * (valueCoeff_k11.*valuefunc_gD2.*phyGweights) ...
        + (lambda+2*mu) * eleP_nu(2) * u_eleP_Pby' * (valueCoeff_k11.*valuefunc_gD2.*phyGweights);
        %> [NTbases_test x Npoints] * [Npoints x 1] = [NTbases_test x 1].
    r2 = p_epsilon*r2 + (p_sigma/areaEdge^p_beta) ...
        *( 1/2*eleP_nu(1)*u_eleP_Pb'* (eleP_nu(2)*phyGweights.*valuefunc_gD1) ...
        + 3/2*u_eleP_Pb' * (phyGweights.*valuefunc_gD2) );
...
%
    ...
    A1_u1v1_PP = ( (lambda+2*mu) * eleP_nu(1) * eleP_testPb' * bsxfun(@times,valueCoeff_1.*phyGaussweights,eleP_trialPbx) ...
        + mu * eleP_nu(2) * eleP_testPb' * bsxfun(@times,valueCoeff_2.*phyGaussweights,eleP_trialPby) );
    A1_u2v1_PP = ( mu * eleP_nu(2) * eleP_testPb' * bsxfun(@times,valueCoeff_2.*phyGaussweights,eleP_trialPbx) ...
        + lambda * eleP_nu(1) * eleP_testPb' * bsxfun(@times,valueCoeff_2.*phyGaussweights,eleP_trialPby));
    A1_u1v2_PP = ( lambda * eleP_nu(2) * eleP_testPb' * bsxfun(@times,valueCoeff_2.*phyGaussweights,eleP_trialPbx) ...
        + mu * eleP_nu(1) * eleP_testPb' * bsxfun(@times,valueCoeff_2.*phyGaussweights,eleP_trialPby) );
    A1_u2v2_PP = ( mu * eleP_nu(1) * eleP_testPb' * bsxfun(@times,valueCoeff_1.*phyGaussweights,eleP_trialPbx) ...
    ...
    A2_u1v1_PP = ( (lambda+2*mu) * eleP_nu(1) * eleP_testPbx' * bsxfun(@times,valueCoeff_1.*phyGaussweights,eleP_trialPb) ...
        + mu * eleP_nu(2) * eleP_testPby' * bsxfun(@times,valueCoeff_2.*phyGaussweights,eleP_trialPb) );
    A2_u1v2_PP = ( mu * eleP_nu(2) * eleP_testPbx' * bsxfun(@times,valueCoeff_2.*phyGaussweights,eleP_trialPb) ...
        + lambda * eleP_nu(1) * eleP_testPby' * bsxfun(@times,valueCoeff_2.*phyGaussweights,eleP_trialPb) );
    A2_u2v1_PP = ( lambda * eleP_nu(2) * eleP_testPbx' * bsxfun(@times,valueCoeff_2.*phyGaussweights,eleP_trialPb) ...
        + mu * eleP_nu(1) * eleP_testPby' * bsxfun(@times,valueCoeff_2.*phyGaussweights,eleP_trialPb));
    A2_u2v2_PP = ( mu * eleP_nu(1) * eleP_testPbx' * bsxfun(@times,valueCoeff_1.*phyGaussweights,eleP_trialPb) ...
...
%     A3.A3_u2v2 = A3_u1v1_PP;
    ...
    A3.A3_u1v1 = A3_u1v1_PP;
    A3.A3_u1v2 = A3_u1v2_PP;
    A3.A3_u2v1 = A3_u2v1_PP;
    A3.A3_u2v2 = A3_u2v2_PP;
