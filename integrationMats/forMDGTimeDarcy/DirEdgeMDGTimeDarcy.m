function [matDirichletEdge_uv,matDirichletEdge_qv1,matDirichletEdge_qv2,rhs_gD1,rhs_gD2,rhs_div] = ...
    DirEdgeMDGTimeDarcy(Coeffs_func, func_gD1, func_gD2, meshInfo, option, formulaGauss1D, degreek_u, degreek_q)
%
...
%
%
%   YcZhang 9/21/2017 -- MM/DD/YYYY
%
%   Last modified 9/21/2017 -- MM/DD/YYYY
%
%
...
%-------------------------------------------------------------------------------------------------------------------%
    ...
    r1 = p_epsilon*r1 + (p_sigma/areaEdge^p_beta)*u_eleP_Pb' * (valuefunc_gD1.*phyGweights);
    ...
    r2 = eleP_nu(1) * u_eleP_Pbx' *  (valueCoeff_k11.*valuefunc_gD2.*phyGweights) ...
        ...
        %> [NTbases_test x Npoints] * [Npoints x 1] = [NTbases_test x 1].
    r2 = p_epsilon*r2 + (p_sigma/areaEdge^p_beta)*u_eleP_Pb' * (valuefunc_gD2.*phyGweights);
