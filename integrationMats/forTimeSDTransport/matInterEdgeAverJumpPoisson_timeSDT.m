function matInterEdge = ...
    matInterEdgeAverJumpPoisson_timeSDT(Coeffs_func, meshInfo, option,formulaGauss1D,degreek_trial,degreek_test)
%
%   %-----------------------------------------
%       Just copy from matInterEdgeAverJumpPoisson_timeSD.m
%   %-----------------------------------------
%
...
for ii = 1:length(interEdges)
    ...
    elemP_nu = meshInfo.nuEdge0Elem{elemP}(:,eIndx_eleP); 
        %> [1 x 2], the outward unit normal vector of ii-th edge on eleP.
    elemM_nu = meshInfo.nuEdge0Elem{elemM}(:,eIndx_eleM); 
