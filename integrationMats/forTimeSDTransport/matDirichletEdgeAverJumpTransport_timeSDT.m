function [diff_DiriK, conv_DiriK] = matDirichletEdgeAverJumpTransport_timeSDT(...
...
%
%   %-----------------------------------------
%       Just copy from matDirichletEdgeAverJumpSDTransport1_Transport.m
%   %-----------------------------------------
%
%   %-----------------------------------------------------------------
...
if isempty(lastStep_DarcyUh)
    error('in matDirichletEdgeAverJumpSDTransport1_Transport.m, lastStep_DarcyUh is []')
end
if isempty(lastStep_StokesUh)
    error('in matDirichletEdgeAverJumpSDTransport1_Transport.m, lastStep_StokesUh is []')
end
