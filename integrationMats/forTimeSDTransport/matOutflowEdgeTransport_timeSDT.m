...
%
%   %-----------------------------------------------------------------
%       Just copy from matOutflowEdgeSDTransport2_Transport.m
%   %-----------------------------------------------------------------
%
%   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
%   %--------------------------------------------
...
if isempty(lastStep_DarcyUh)
    error('in matOutflowEdgeSDTransport2_Transport.m, lastStep_DarcyUh is []')
end
if isempty(lastStep_StokesUh)
    error('in matOutflowEdgeSDTransport2_Transport.m, lastStep_StokesUh is []')
end
...
%-- check the outflow edge and LastStep Uh
