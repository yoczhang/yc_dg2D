function [matInterEdge_u1v1, matInterEdge_u1v2, matInterEdge_u2v1, matInterEdge_u2v2, matInterEdge_qv1, matInterEdge_qv2] = ...
    matInterEdgeAverJumpTensorStokes_timeSDT(Coeffs_func, meshInfo, option, formulaGauss1D, degreek_u, degreek_p)
%
%   %-----------------------------------------
%       Just copy from matInterEdgeAverJumpTensorStokes_timeSD.m
%   %-----------------------------------------
%
