...
%
%          Modified:  16-Jul-13   Tomas Zegard
%          Fix the color axis scaling by calling caxis([0 1]);
%
%          Modified:  16-Aug-13   Anderson Pereira
%          Removed one line of code by collapsing two "if's" for checking
%          if the element is constant or not (fem.Reg flag)
%-------------------------------------------------------------------------%