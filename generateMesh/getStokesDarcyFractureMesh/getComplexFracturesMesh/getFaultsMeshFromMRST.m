function [G_fault, originalFracture] = getFaultsMeshFromMRST()
%
%
%   ComplexFaultNetwork
%   MRST 
...
faults = {
    ...
    %[0.36, 0.7; 0.415, 0.80; 0.42, 0.83; 0.43, 0.85];
    [0.13,0.24; 0.16,0.26; 0.18,0.28; 0.20,0.3; 0.22,0.32; .24,0.38; 0.26,0.6;];
    [0.2,0.6; 0.22,0.56; 0.24,0.52; 0.26,0.5; 0.28,0.46; 0.32,0.40; 0.36,0.34; 0.38,0.28; 0.4,0.22; 0.405,0.21; 0.5,0.1; 0.53,0.06];
    [0.5,0.53; 0.55,0.55; 0.60,0.60; 0.65,0.62; 0.7,0.65; 0.85,0.85; 0.9,0.87; 0.92,0.86; ];
    };
