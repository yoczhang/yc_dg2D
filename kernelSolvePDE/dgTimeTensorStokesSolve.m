function [Uh, sysInfo] = dgTimeTensorStokesSolve(StokesmeshInfo,pde,option)
%
...
% tensor Stokes
[elem_u0v0,elem_p0q0,elem_uxvx,elem_uxvy,elem_uyvx,elem_uyvy,elem_pv1,elem_pv2,rhs_u10,rhs_u20,rhs_p0,lambda_p] = ...
    matElemCoeffsDuDvTimeTensorStokes(Coeffs_func,pde.u10,pde.u20, pde.p0, StokesmeshInfo,Gaussformulas{1}, degree_u, degree_p);

[Inter_u1v1, Inter_u1v2, Inter_u2v1, Inter_u2v2, Inter_pv1, Inter_pv2] = ...
    matInterEdgeAverJumpTimeTensorStokes(Coeffs_func, StokesmeshInfo, option, formulaGauss1D, degree_u, degree_p);

[Diri_u1v1,Diri_u1v2,Diri_u2v1,Diri_u2v2,Diri_pv1,Diri_pv2,~,~,~] = ...
    matDirichletEdgeAverJumpTimeTensorStokes(Coeffs_func, pde.gD1, pde.gD2, StokesmeshInfo, option, formulaGauss1D, degree_u, degree_p);
...
Stokes_stiff = [mu*(elem_u1v1+Inter_u1v1+Diri_u1v1),      mu*(elem_u2v1+Inter_u2v1+Diri_u2v1),     -elem_pv1+Inter_pv1+Diri_pv1,     zeros(dof_u1,1);
...
for n = 0:NT-1
    ...
    [S_rhs_f1, S_rhs_f2] = vecElemRhsFtTensorStokes(t, pde.f1, pde.f2, StokesmeshInfo, Gaussformulas{1}, degree_u);
    vecRhs_f = [S_rhs_f1;S_rhs_f2;zeros(dof_p,1);0];
    
    if strcmpi(bd_case,'allDirichlet')
        [S_rhs_gD1, S_rhs_gD2, S_rhs_div] = vecEdgeRhsDirTimeTensorStokes(t, Coeffs_func, pde.gD1, pde.gD2, ...
