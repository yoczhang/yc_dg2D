function [Uh, sysInfo, system] = dgStokesDarcySolve_usingScalarStokes(StokesmeshInfo,DarcymeshInfo,pde,option)
%
...
%     matElemCoeffsDuDvTensorStokes(Coeffs_func,pde.f1,pde.f2, StokesmeshInfo,Gaussformulas{1}, degree_u, degree_p);
% 
% [Inter_u1v1, Inter_u1v2, Inter_u2v1, Inter_u2v2, Inter_pv1, Inter_pv2] = ...
%     matInterEdgeAverJumpTensorStokes(Coeffs_func, StokesmeshInfo, option, formulaGauss1D, degree_u, degree_p);
% 
% [Diri_u1v1,Diri_u1v2,Diri_u2v1,Diri_u2v2,Diri_pv1,Diri_pv2,rhs_gD1,rhs_gD2,rhs_div] = ...
%     matDirichletEdgeAverJumpTensorStokes(Coeffs_func, pde.gD1, pde.gD2, StokesmeshInfo, option, formulaGauss1D, degree_u, degree_p);

[elem_u1v1,elem_pv1,elem_pv2,~,rhsf1,rhsf2,~] = ...
    matElemCoeffsDtrialDtestScalarStokes_SD(Coeffs_func,pde.f1,pde.f2, StokesmeshInfo,Gaussformulas{1}, degree_u, degree_p);

[Inter_u1v1, Inter_pv1, Inter_pv2] = ...
    matInterEdgeAverJumpScalarStokes_SD(Coeffs_func, StokesmeshInfo, option, formulaGauss1D, degree_u, degree_p);

[Diri_u1v1,Diri_pv1,Diri_pv2,rhs_gD1,rhs_gD2,rhs_div] = ...
    matDirichletEdgeAverJumpScalarStokes_SD(Coeffs_func, pde.gD1, pde.gD2, StokesmeshInfo, option, formulaGauss1D, degree_u, degree_p);
...
StokesM = [mu*(elem_u1v1+Inter_u1v1+Diri_u1v1)+Kappa*interface_u1v1,      zeroUU+Kappa*interface_u2v1,     -elem_pv1+Inter_pv1+Diri_pv1;
    zeroUU+Kappa*interface_u1v2,     mu*(elem_u1v1+Inter_u1v1+Diri_u1v1)+Kappa*interface_u2v2,      -elem_pv2+Inter_pv2+Diri_pv2;
    -(-elem_pv1+Inter_pv1+Diri_pv1)',     -(-elem_pv2+Inter_pv2+Diri_pv2)',     zeroPP];

% StokesM = [nu*(elem_u1v1+Inter_u1v1+Diri_u1v1)+Ct*interface_u1v1,      nu*(elem_u2v1+Inter_u2v1+Diri_u2v1)+Ct*interface_u2v1,     -elem_pv1+Inter_pv1+Diri_pv1;
%     nu*(elem_u1v2+Inter_u1v2+Diri_u1v2)+Ct*interface_u1v2,     nu*(elem_u2v2+Inter_u2v2+Diri_u2v2)+Ct*interface_u2v2,      -elem_pv2+Inter_pv2+Diri_pv2;
%     -(-elem_pv1+Inter_pv1+Diri_pv1)',     -(-elem_pv2+Inter_pv2+Diri_pv2)',     zeroPP];
...
elseif (strcmpi(pde.pdecase,'case3') || strcmpi(pde.pdecase,'case6') ...
...
elseif strcmpi(pde.pdecase,'case5')
        %> in pde case4, the interface is setted by y==1/2.
