function [Uh, sysInfo] = dgTimeStokesDarcySolve_usingTensorStokes(StokesmeshInfo,DarcymeshInfo,pde,option)
%
...
[elem_u0v0,elem_p0q0,elem_uxvx,elem_uxvy,elem_uyvx,elem_uyvy,elem_pv1,elem_pv2,rhs_u10,rhs_u20,rhs_p0,~] = ...
    matElemCoeffsDuDvTensorStokes_timeSD(Coeffs_func,pde.u10,pde.u20, pde.p0, StokesmeshInfo,Gaussformulas{1}, degree_u, degree_p);

[Inter_u1v1, Inter_u1v2, Inter_u2v1, Inter_u2v2, Inter_pv1, Inter_pv2] = ...
    matInterEdgeAverJumpTensorStokes_timeSD(Coeffs_func, StokesmeshInfo, option, formulaGauss1D, degree_u, degree_p);

[Diri_u1v1,Diri_u1v2,Diri_u2v1,Diri_u2v2,Diri_pv1,Diri_pv2,~,~,~] = ...
    matDirichletEdgeAverJumpTensorStokes_timeSD(Coeffs_func, pde.gD1, pde.gD2, StokesmeshInfo, option, formulaGauss1D, degree_u, degree_p);
...
[interface_u1v1, interface_u2v1, interface_u1v2, interface_u2v2] = ...
    matInterfaceOfStokes_timeSD(Coeffs_func, StokesmeshInfo, interfacemeshInfo, formulaGauss1D, degree_u);
...
[Darcy_u0v0, Darcy_DuDv, Darcy_rhs_phi0] = ...
    matElemCoeffsDtrialDtestPoisson_timeSD(Coeffs_func,pde.phi0,DarcymeshInfo,Gaussformulas{1}, degree_phi, degree_phi);
Darcy_interE = ...
    matInterEdgeAverJumpPoisson_timeSD(Coeffs_func, DarcymeshInfo,option,Gaussformulas{3},degree_phi,degree_phi);
[Darcy_DirichletE, ~] = ...
    matDirichletEdgeAverJumpPoisson_timeSD(Coeffs_func,pde.gDp,DarcymeshInfo,option,Gaussformulas{3},degree_phi,degree_phi);
...
disp(['condition number of systemM: ', num2str(condest(SD_A))])
...
Uh0 = [phi_0;u1h_0;u2h_0;ph_0];

SD_sysM = SD_M + option.theta*Dt*SD_A;
right_term = SD_M + (option.theta-1)*Dt*SD_A;
...
for n = 0:NT-1
    ...
    vecRhs_f = [D_rhs_fp;S_rhs_f1;S_rhs_f2;zeros(dof_p,1)];
    ...
    if strcmpi(bd_case,'allDirichlet')
        ...
        rhs_DiriBC = [D_rhs_gD1;mu*S_rhs_gD1;mu*S_rhs_gD2;-S_rhs_div];
        
        SD_sysRhs = right_term*Uh0 + Dt*(vecRhs_f + rhs_DiriBC);
    else
        error('error in dgTimeStokesDarcySolve_usingTensorStokes.m')
    end % if
    

    Uh = SD_sysM\SD_sysRhs; 
