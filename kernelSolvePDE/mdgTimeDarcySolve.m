function [Uh, sysInfo] = mdgTimeDarcySolve(meshInfo,pde,option)
%
...
for n = 0:NT-1
    ...
    vecRhs_f = [rhs_f1;rhs_f2;zeros(dof_p,1);0];
...
%         rhs_DiriBC = [rhs_pD1;rhs_pD2;sparse(dof_p,1);0];
%         sysRhs = right_term*Uh0 + Dt*(vecRhs_f - rhs_DiriBC);
        ...
        rhs_DiriBC = [rhs_gD1; rhs_gD2; -rhs_div; 0];
        sysRhs = right_term*Uh0 + Dt*(vecRhs_f + rhs_DiriBC);
