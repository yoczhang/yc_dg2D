function [SD_Uh, Ch, sysInfo] = dgTimeDecoupledSDTSolve2(StokesmeshInfo,DarcymeshInfo,pde,option)
%
%   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
%   %--------------------------------------------
%       dgTimeDecoupledSDT2, 
...
for n = 0:NT-1
    ...
    C_K_outflow = ...
        matOutflowEdgeTransport_timeSDT(pde, ...
        DarcymeshInfo, StokesmeshInfo, ...
        lastStep_DarcyUh, lastStep_StokesUh, ...
        formulaGauss1D, degree_phi, degree_u, degree_c, degree_c ); % need to check the code again, 24/10/2017
    C_A = C_GxxPlusGyy + C_diff_K_noAdapInterE + C_diff_K_AdapInterE ...
        - C_u1G0xPlusu2G0y + C_conv_K_InterE + C_K_outflow;
    ...
    C_rhs_Inflow = vecInflowEdgeSDTransport_timeSDT(t, pde, ...
        DarcymeshInfo, StokesmeshInfo, ...
        lastStep_DarcyUh, lastStep_StokesUh, ...
        formulaGauss1D, degree_phi, degree_u, degree_c);
    if n==0, Ch0 = C_G\Transp_rhs0; end
    C_sysRhs = C_rhs_term*Ch0 + Dt*(C_rhs_fc - C_rhs_Inflow);
    Ch = C_sysM\C_sysRhs;
