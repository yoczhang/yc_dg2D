...
% CRACK(i+1,1) = x-coordinate of 2nd point of ith segment/1st point (i+1)th segment
% CRACK(i+1,2) = y-coordinate of 2nd point of ith segment/1st point (i+1)th segment
...
MAT       = [50,0,50,0,2,0,Inf];
CRACK     = [0 0.5 1 0.5;0.4 0.4 0.6 0.6];
INC       = [];
VOID      = [];
GROW      = [1 0];
FORCE     = [1 0 1];
