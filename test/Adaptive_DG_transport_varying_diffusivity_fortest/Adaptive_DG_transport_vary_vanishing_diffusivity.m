function Adaptive_DG_transport_vary_vanishing_diffusivity
...
%-- mesh 1
% [node,elem] = squaremesh([0,2,0,1],1/40);
...
left_matrix=M+(1-theta_time)*delta_t*(A1-A2+A3+A4+A5+A6);
right_matrix=M-theta_time*delta_t*(A1-A2+A3+A4+A5+A6);
...
% [DGM_yc, DGT_yc, DGuh_yc] = dgPolygonPoltResult(r_0, meshInfo, 1);
