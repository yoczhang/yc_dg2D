...
% function XFEM2dRodBiMat_AbsEnr_yctest2(TestCase)
function XFEM2dRodBiMat_AbsEnr_yctest2
TestCase=1;
...
%----------------------------------------
[yc_xx1, iirow] = sort(xx);
yc_yy1 = yy(iirow);
lxx = floor(0.3*length(xx));
yc_xx2 = yc_xx1(1:lxx);
yc_yy2 = yc_yy1(1:lxx);
%---------------------------------------
aa=1; bb=0; cc=-0.5; % Vertical disc. at x=0.5.
ff = GetLevelSet(aa, bb, cc, yc_xx2, yc_yy2);
PlotLevelSet_yctest(Mesh, yc_xx2, yc_yy2, ff, ElemNum)
