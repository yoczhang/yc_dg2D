...
for i = 1 : nQ
    ...
    NxNxT = [Nx; Mx; F1x; F2x; F3x; F4x] * [Nx; Mx; F1x; F2x; F3x; F4x]';
    NxNyT = [Nx; Mx; F1x; F2x; F3x; F4x] * [Ny; My; F1y; F2y; F3y; F4y]';
    NyNxT = [Ny; My; F1y; F2y; F3y; F4y] * [Nx; Mx; F1x; F2x; F3x; F4x]';
    NyNyT = [Ny; My; F1y; F2y; F3y; F4y] * [Ny; My; F1y; F2y; F3y; F4y]';
