function r=generate_load_vector_local_DG_initial_solution(func_right_term,t,DGM,DGT...
...
for n=1:size(DGT,2)
    ...
    for k=1:length(Gauss_coefficient_local)  
        a=feval(func_right_term,Gauss_point_local(k,1),Gauss_point_local(k,2),t)...
