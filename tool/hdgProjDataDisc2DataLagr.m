function [LagrX, LagrY, dataLagr] = hdgProjDataDisc2DataLagr(dataDisc, g_mesh, degreek)
%
%
...
%
%   input:
%       dataDisc, [Nbases*Nelems x 1], the HDG solution on Elems.
...
LagrX = g_mesh.mapRef2Phy(1,Lx,Ly); % [Nelems x NLpoints]
LagrY = g_mesh.mapRef2Phy(2,Lx,Ly); % [Nelems x NLpoints]
